...
`Python` Â· `PyTorch` Â· `PySpark` Â· `Ray` Â· `Flyte`

**Generative AI & LLMs**  
`Agentic Workflows` Â· `Agents SDK` Â· `CodeAct patterns` Â· `Large Scale RAG` Â· `PEFT (LoRA)` Â· `RLHF/RL (GRPO style)` Â· `Distillation` Â· `Prompt Engineering`

**Inference & MLOps**  
`vLLM` Â· `SGLang` Â· `Distributed inference` Â· `ML System Design`

**Data & Search**  
`Vector Databases` Â· `Semantic Search` Â· `Multimodal Embeddings`

---

## PROFESSIONAL EXPERIENCE

### **Machine Learning Scientist III** Â· *Expedia Group*

*London, UK* Â· `January 2025 â€“ Present`
...
### **Full Stack ML Scientist/Engineer** Â· *Expedia Group (Legal & Corporate Affairs)*

*London, UK* Â· `January 2026 â€“ Present` Â· *Internal Rotation â€“ 50%*
...
### **Machine Learning Scientist II** Â· *Expedia Group*

*London, UK* Â· `August 2022 â€“ January 2025`
...
- Pioneered efficient large-scale inference practices using Ray-over-Spark for multi-node, multi-GPU environments
- Contributed to and adopted frameworks such as vLLM and SGLang to create cost-effective batch pipelines

---

### **Machine Learning Scientist Intern** Â· *Expedia Group*

*London, UK* Â· `Summer 2021`
...
### **MSci Data Science** Â· *University of Warwick*

*United Kingdom* Â· `2018 â€“ 2022`

> Accredited by Royal Society of Statistics

**Thesis:** "Using Reinforcement Learning Approaches to Trading"  
Investigated algorithmic trading approaches, using quantitative analysis to compare LSTM-based algorithms against traditional rule-based methods.

---

## PREVIOUS INTERNSHIPS

**Product Manager Intern** Â· *Crypcentra* Â· `August 2020 â€“ October 2020`

**Summer Intern** Â· *Euroclear* Â· `August 2018`
